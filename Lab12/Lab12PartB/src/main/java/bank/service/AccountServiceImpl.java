...
//	private Logger logger;
	...
	public AccountResponse createAccount(long accountNumber, String customerName) {
		...
		publisher.publishEvent(new AccountChangeEvent("New account created", accountResponse, 0.0));
	...
	public void deposit(long accountNumber, double amount) {
		...
		AccountResponse accountResponse = AccountAdapter.getAccountResponseFromAccount(account);
		publisher.publishEvent(new AccountChangeEvent("Deposit", accountResponse, amount));
	}
	...
	public void withdraw(long accountNumber, double amount) {
		...
		logger.info("withdraw with parameters accountNumber= " + accountNumber
				+ " , amount= " + amount);
		AccountResponse accountResponse = AccountAdapter.getAccountResponseFromAccount(account);
		publisher.publishEvent(new AccountChangeEvent("Withdrawal", accountResponse, amount));
	}
	...
	public void depositEuros(long accountNumber, double amount) {
		...
		AccountResponse accountResponse = AccountAdapter.getAccountResponseFromAccount(account);
		publisher.publishEvent(new AccountChangeEvent("Deposit Euro", accountResponse, amountDollars));
	}
	...
	public void withdrawEuros(long accountNumber, double amount) {
		...
		logger.error("withdrawEuros with parameters accountNumber= "
				+ accountNumber + " , amount= " + amount);
		AccountResponse accountResponse = AccountAdapter.getAccountResponseFromAccount(account);
		publisher.publishEvent(new AccountChangeEvent("Withdraw Euros", accountResponse, amountDollars));
	}
	...
	public void transferFunds(long fromAccountNumber, long toAccountNumber,
		...
		publisher.publishEvent(new AccountChangeEvent("Transfer Funds", accountResponse, amount));
	}
}
